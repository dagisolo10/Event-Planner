...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    return (
        <div className={`sm-scope z-40 ${isFixed ? "fixed top-0 left-0 h-screen w-full overflow-hidden" : "h-full w-full"}`}>
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <span ref={iconRef} className="sm-icon relative inline-flex h-3.5 w-3.5 shrink-0 items-center justify-center will-change-transform" aria-hidden="true">
                            <span ref={plusHRef} className="sm-icon-line absolute top-1/2 left-1/2 h-0.5 w-full -translate-x-1/2 -translate-y-1/2 rounded-[2px] bg-current will-change-transform" />
                            <span
                                ref={plusVRef}
                            ...
                            {items && items.length ? (
                                items.map((it, idx) => (
                                    <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                                        <a
                                            ...
                                            data-index={idx + 1}
                                        >
                                            <span className="sm-panel-itemLabel inline-block origin-[50%_100%] will-change-transform">{it.label}</span>
                                        </a>
                                    </li>
                                ))
                            ) : (
                                <li className="sm-panel-itemWrap relative overflow-hidden leading-none" aria-hidden="true">
                                    <span className="sm-panel-item relative inline-block cursor-pointer pr-[1.4em] text-[4rem] leading-none font-semibold tracking-[-2px] text-black uppercase no-underline transition-[background,color] duration-150 ease-linear">
                                        <span className="sm-panel-itemLabel inline-block origin-[50%_100%] will-change-transform">No items</span>
                                    </span>
                                </li>
                            )}
                        </ul>
