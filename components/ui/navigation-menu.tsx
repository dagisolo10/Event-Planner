...
const navigationMenuTriggerStyle = cva(
    "group inline-flex h-9 w-max items-center text-muted-foreground justify-center rounded-md py-2 text-sm font-medium transition-[color,box-shadow] outline-none hover:text-accent-foreground focus:text-accent-foreground focus-visible:ring-[1px] focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-accent-foreground",
);
